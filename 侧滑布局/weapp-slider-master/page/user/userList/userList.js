...
Page({
  ...
  data: {
    ...
    xiaoliang_id: 0,//销量
    xiaoliang_txt: '',
    companyList: [{ id: 1, name: "名字1" }, { id: 2, name: "名字2" }, { id: 3, name: "名字3" }, { id: 4, name: "名字4" }],
    msgList: [],
    height: 0,
    scrollY: true,
    onOff: true ,
    ...
    sortid: null,  //排序id
    filter: {},
    conferencelist: [{ id: 1, name: "名字1" }, { id: 2, name: "名字2" }, { id: 3, name: "名字3" }, { id: 4, name: "名字4" }], //会议室列表列表
    scrolltop: null, //滚动位置
    page: 0,  //分页
 ...
 */
  ...
  checkboxAll:function(e){
    ...
    if (!selectedAllStatus){
      this.setData({ checkboxSingle: true });
    }else{
      this.setData({ checkboxSingle: false });
    }
    this.setData({ checkboxAll: !selectedAllStatus });
